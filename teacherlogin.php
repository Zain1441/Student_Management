<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = mysqli_real_escape_string($con,$_POST['teacherid']);
      $mypassword = mysqli_real_escape_string($con,$_POST['password']); 
      
      $sql = "SELECT id FROM teacher WHERE id = '$myusername' and teacher_password = '$mypassword'";
          ...
          <div class="row">
            <div class="col-sm-6 text-black">
              ...
              <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                ...
                <form style="width: 23rem;" action=teacherlogin.php method="post">>
      
                  <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in</h3>
    
                  <div class="form-outline mb-4">
                    <input type="text" name=teacherid id="teacherid" class="form-control form-control-lg" />
